    ...
    return (
        <Section className="min-h-[100svh] flex flex-col relative overflow-hidden pb-12 pt-8 md:justify-center md:py-24">
            ...
            <div className="absolute inset-0 z-0 bg-[#0A0A0A]">
                ...
                <div className="absolute top-0 right-0 w-full md:w-[60%] h-[65vh] md:h-full md:left-auto">
                    <img
                        src="/Mila.jpeg"
                        alt="Mila Moraes"
                        className="w-full h-full object-cover object-[70%_top] md:object-top opacity-60 md:opacity-80"
                        style={{ maskImage: 'linear-gradient(to bottom, black 40%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 40%, transparent 100%)' }}
                    />
                </div>

                {/* Gradient for mobile: dark text shadow on the left for badges */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#0A0A0A]/80 to-transparent md:hidden z-10" />
